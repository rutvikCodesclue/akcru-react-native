export const Akcru_Content = [
  {
    id: 'AllMovies',
    title: 'All Movies',
    movies: [
      {
        actors: ['Viola Davis', 'Liam Neeson', 'Michelle Rodriguez'],
        desc: "Four women with nothing in common except a debt left behind by their dead husbands' criminal activities take fate into their own hands and conspire to forge a future on their own terms.",
        directors: ['Steve McQueen'],
        genre: ['Crime', 'Drama', 'Thriller'],
        portrait_poster:
          'https://priymuscontent.s3.amazonaws.com/Beta+test+posters/widowsPT.jpg',
        landscape_poster:
          'https://priymuscontent.s3.amazonaws.com/Beta+test+posters/WidowsLS.jpg',
        ...
        id: '0',
        movie_url:
          'https://priymuscontent.s3.amazonaws.com/Movie+folder/Widows.mp4',
        youtubetrailer: 'nN2yBBSRC78',
      },
      {
        actors: ['Constance Wu', 'Jennifer Lopez', 'Julia Stiles'],
        desc: 'Inspired by the viral New York Magazine article, Hustlers follows a crew of savvy former strip club employees who band together to turn the tables on their Wall Street clients.',
        directors: ['Lorene Scafaria'],
        genre: ['Comedy', 'Crime', 'Drama'],
        portrait_poster:
          'https://priymuscontent.s3.amazonaws.com/Beta+test+posters/HustlersPT.jpg',
        landscape_poster:
          'https://priymuscontent.s3.amazonaws.com/Beta+test+posters/hustlersLS.webp',
        ...
        id: '1',
        movie_url:
          'https://priymuscontent.s3.amazonaws.com/Movie+folder/Hustlers.mp4',
        youtubetrailer: 'EpyogCVnI6Q',
      },
      {
        ...
        portrait_poster:
          'https://priymuscontent.s3.amazonaws.com/Beta+test+posters/ArrivalPT.jpg',
        landscape_poster:
          'https://priymuscontent.s3.amazonaws.com/Beta+test+posters/ArrivalLS.jpg',
        ...
        id: '2',
        movie_url:
          'https://priymuscontent.s3.amazonaws.com/Movie+folder/Arrival.mp4',
        youtubetrailer: 'ZLO4X6UI8OY',
      },
      {
        ...
        landscape_poster:
          'https://cdn.fandomwire.com/wp-content/uploads/2023/05/20232258/Tom-Hardy-2.jpg',
        ...
        id: '3',
        movie_url:
          'https://priymuscontent.s3.amazonaws.com/Movie+folder/Warrior.mp4',
        youtubetrailer: 'ZLO4X6UI8OY',
      },
      {
      ...
      },
      {
        ...
        desc: "The true story of Molly Bloom, an Olympic-class skier who ran the world's most exclusive high-stakes poker game and became an FBI target.",
        directors: ['Aaron Sorkin'],
        genre: ['Biography', 'Crime', 'Drama'],
        portrait_poster:
          'https://priymuscontent.s3.amazonaws.com/Beta+test+posters/MollygamePT.jpg',
        landscape_poster:
          'https://priymuscontent.s3.amazonaws.com/Beta+test+posters/mollygameLS.jpg',
        ...
        id: '5',
        movie_url:
          'https://priymuscontent.s3.amazonaws.com/Movie+folder/MollyGame..mp4',
        youtubetrailer: 'Vu4UPet8Nyc',
      },
      {
        ...
        portrait_poster:
          'https://priymuscontent.s3.amazonaws.com/Beta+test+posters/1917PT.jpg',
        landscape_poster:
          'https://priymuscontent.s3.amazonaws.com/Beta+test+posters/1917LS.jpg',
        ...
        id: '6',
        movie_url:
          'https://priymuscontent.s3.amazonaws.com/Movie+folder/1917.mp4',
        youtubetrailer: 'cNazwelUt2E',
      },
      {
        actors: ['Neve Campbell', 'Courtney Cox', 'David Arquette'],
        desc: "25 years after a streak of brutal murders shocked the quiet town of Woodsboro, Calif., a new killer dons the Ghostface mask and begins targeting a group of teenagers to resurrect secrets from the town's deadly past.",
        directors: ['Matt Bettinelli-Olpin', 'Tyler Gillett'],
        genre: ['Horror', 'Mystery', 'Thriller'],
        portrait_poster:
          'https://priymuscontent.s3.amazonaws.com/Beta+test+posters/screamPT.jpg',
        landscape_poster:
          'https://priymuscontent.s3.amazonaws.com/Beta+test+posters/screamLS.jpg',
        ...
        id: '7',
        movie_url:
          'https://priymuscontent.s3.amazonaws.com/Movie+folder/Scream.mp4',
        youtubetrailer: '-TfkyBWEoWY',
      },
      {
  ...
  },
  {
    ...
    movies: [
      ...
      },
      {
        ...
        id: '4',
        movie_url: '',
        youtubetrailer: 'CZ1CATNbXg0',
      },
    ],
  },
  {
    id: 'ViewUserWatchlist',
    title: '',
    movies: [
      {
        actors: ['Amy Adams', 'Jeremy Renner', 'Forest Whitaker'],
