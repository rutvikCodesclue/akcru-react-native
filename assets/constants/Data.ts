...
export const MOVIES = [
  ...
  },
  {
    ...
    desc: 'Zombie action in the Alps: a group of young snowboarder is stuck in a remote mountain ski resort, where an all-night aprés-ski party soon turns into a hellish nightmare of zombie mayhem.',
    directors: ['Dominik Hartl'],
    genre: ['Crime', 'Drama', 'Mystery'],
    image_url:
      'https://priymus.com/wp-content/uploads/2022/08/Attack-of-the-Lederhosen-Zombies_2700x4050-copy-200x300.jpg',
    thumb_url:
      'https://priymus.com/wp-content/uploads/2022/08/Attack-of-the-Lederhosen-Zombies_Still-1_1920x1080-300x169.jpg',
    imdb_url: '/title/tt0051201/',
    name: 'Attack of the Lederhosen Zombies',
    rating: 8.4,
    year: 2016,
    rated: 'NR',
    length: '1h 18m',
    id: '1',
    movie_url:
      'https://priymuscontent.s3.amazonaws.com/Movie+folder/Attack+of+the+Lederhosen+Zombies_Feature+subtitles.mp4',
    youtubeID: 'PGgZtLIdZ8s',
  },
  {
    actors: ['Miles Teller', 'J.K. Simmons', 'Melissa Benoist'],
    desc: "A promising young drummer enrolls at a cut-throat music conservatory where his dreams of greatness are mentored by an instructor who will stop at nothing to realize a student's potential.",
    ...
    image_url:
      'https://m.media-amazon.com/images/M/MV5BOTA5NDZlZGUtMjAxOS00YTRkLTkwYmMtYWQ0NWEwZDZiNjEzXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg',
    thumb_url:
      'https://thebluemomentdotcom.files.wordpress.com/2015/01/whiplash-poster.jpg',
    imdb_url: '/title/tt2582802/',
    name: 'Whiplash',
    rating: 8.5,
    year: 2014,
    ...
    id: '2',
    movie_url:
      'https://priymuscontent.s3.amazonaws.com/Movie+folder/Whiplash.mp4',
  ...
  },
  {
    ...
    genre: ['Thriller'],
    image_url: 'https://m.media-amazon.com/images/I/81v18fCWa6L._RI_.jpg',
    thumb_url:
