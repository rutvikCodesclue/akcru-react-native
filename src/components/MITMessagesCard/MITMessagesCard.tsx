...
const MITMessages = ({inviteePicture, inviteeName, akcruBadge, influencer, avatarbordercolor}: MITMessagesProps) => {
    return (
        <View>
            <View style={styles.cardcontainer}>
                <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                    ...
                    <View>
                        <Text style={styles.stamps}>{FAKE_USER_PROFILES[3].CruChatDate}</Text>
                        <Text style={styles.stamps2}>{FAKE_USER_PROFILES[3].CruChatTime}</Text>
                    </View>
                </View>
                <View>
            ...
            <View style={styles.cardcontainer}>
                <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                    ...
                    <View>
                        <Text style={styles.stamps}>{FAKE_USER_PROFILES[0].CruChatDate}</Text>
                        <Text style={styles.stamps2}>{FAKE_USER_PROFILES[0].CruChatTime}</Text>
                    </View>
                </View>
                <View>
