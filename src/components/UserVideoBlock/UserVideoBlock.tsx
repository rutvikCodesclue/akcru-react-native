...
const UserMITVideoBlock: React.FC<Props> = ({userPicture, userName, host, onPress}) => {
                ...
                <View style={styles.bottomtab}>
                    <Pressable onPress={toggleUserMic} style={{marginRight: 10}}>
                        {isUserMicOn ? (
                            ...
                            <Icon name="mic-off" type="ionicon" size={28} color={COLORS.CATREDLGT} />
                        )}
                    </Pressable>
                    <Pressable onPress={onPress}>
                        <Text style={{...FONTS.Title3}} numberOfLines={1} ellipsizeMode="tail">
...
const UserCRUVideoBlock: React.FC<Props> = ({userPicture, userName, host, onPress, userID, hmsView}) => {
    const [isUserMicOn, setIsUserMicOn] = useState(true);
