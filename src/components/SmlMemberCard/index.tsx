import {View, Text, TextInput, Modal, FlatList, TouchableOpacity, Pressable, ScrollView} from 'react-native';
...
type SmlMemberCardProps = {
    ...
    // AddHost: (userID: any) => void;
    // terminateMember: (userID: any) => void;
};
