...
const HexAvatar = ({source, size, bordercolor}: HexAvatarProp) => {
    ...
    return (
        <View style={{width: size, height: size, alignItems: 'center', justifyContent: 'center'}}>
            ...
            <MaskedView
                ...
                <Image source={source.uri? {uri: source.uri}: imageindex.Akcruplaceholder} style={{width: size, height: size, alignSelf: 'center'}} resizeMode="cover" />
            </MaskedView>
        </View>
    );
};
