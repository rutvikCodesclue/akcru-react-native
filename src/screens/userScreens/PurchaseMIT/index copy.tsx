                  ...
                  <ScrollView>
                      <View style={{marginBottom: 100}}>
                          ...
                          <View style={styles.pricecontainer}>
                              ...
                              <Text style={styles.mitprice}>4,000 AD</Text>
                          ...
                          <View style={styles.pricecontainer}>
                              ...
                              <Text style={styles.mitprice}>3,200 AD</Text>
                              <AkcruButtons.LrgButton btnname="PURCHASE" color={COLORS.CATPURPDRK} onPress={() => {}} />
                          </View>
                          <View style={styles.pricecontainer}>
                              ...
                              <Text style={styles.mitprice}>2,000 AD</Text>
                              <AkcruButtons.LrgButton btnname="PURCHASE" color={COLORS.CATPURPDRK} onPress={() => {}} />
                          </View>
                      </View>
                  </ScrollView>
...
export default PurchaseMITScreen2;
