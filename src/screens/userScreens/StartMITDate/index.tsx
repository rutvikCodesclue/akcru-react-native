...
type StartMITDateNavigationProp = StackNavigationProp<UserProfileStackParams, 'StartMITDate'>;
...
const StartMITDate = ({navigation, route, dateID}: Props) => {
    ...
    return (
        <SafeAreaView>
            <ScrollView stickyHeaderIndices={[0]} style={{marginBottom: SIZES.ScreenHeight / 12}}>
                    ...
                    {isStreamOpen ? (
                        <View style={styles.moviecontainer}>
                            ...
                            <View style={{marginRight: 10}}>
                                <Image source={{uri: JENNY_SCHEDULE[id].moviePoster}} style={styles.poster} />
                            </View>
                            <View>
                                <Text style={{...FONTS.Title3}}>{JENNY_SCHEDULE[id].movieName}</Text>
                                <View
                                    style={{
                                        flexDirection: 'row',
                                        marginVertical: 8,
                                    ...
                                    <Text style={{...FONTS.Title2, fontSize: 12}}>{JENNY_SCHEDULE[id].movieYear}</Text>
                                    <Text
                                        style={{
                                            ...FONTS.Title2,
                                            fontSize: 12,
                                    ...
                                    <Text style={styles.drawfonttag}>{JENNY_SCHEDULE[id].movieRated}</Text>
                                    <Text style={styles.drawfonttag}>{JENNY_SCHEDULE[id].movieGenre}</Text>
                                    <Text style={styles.drawfonttag}>{JENNY_SCHEDULE[id].movieRating}/10</Text>
                                </View>
                ...
                <BottomSheet
                    ...
                    <View style={{marginHorizontal: 15}}>
                        <View style={styles.input}>
                            ...
                            <AkcruButtons.XSmallButton btnname={'REPLY'} onPress={function (): void {}} color="" />
                        </View>
                    </View>
                </BottomSheet>
            </ScrollView>
