...
const CrummunityScreen = ({navigation, route}: Props) => {
    ...
    //         try {
    //             const finalResponse = await newVisitCrum();
    //             if (finalResponse) {
    //                 console.log('success', finalResponse);
    //                 setFirstUser(finalResponse);
    //             }
    //         } catch (error) {
    //             console.log(error);
    //         }
    ...
    //             const isNewVisitCrum = await newVisitCrum();
    //             if (isNewVisitCrum) {
    //                 console.log('success', isNewVisitCrum);
    //                 setFirstUser(isNewVisitCrum);
    //                 // Call the second API only if the first API returns true
    //                 const updateUserResponse = await newUserUpdate();
    //                 console.log('update user response', updateUserResponse);
    //             } else {
    //                 console.log('not a new visit crum');
    //             }
    //         } catch (error) {
    //             console.log(error);
    //         }
    ...
    //     async function fetchData() {
    //         try {
    //             const [firstUserCome, comeUpdateUser] = await Promise.all([newVisitCrum(), newUserUpdate()]);
    //             if (firstUserCome) {
    //                 console.log('success', firstUserCome);
    //             }
    //             if (comeUpdateUser) {
    //                 console.log('update', comeUpdateUser);
    //             }
    //         } catch (error) {
    //             console.log(error);
    //         }
