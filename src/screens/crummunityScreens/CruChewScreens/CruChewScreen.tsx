...
const CruChewScreen = () => {
    const navigation = useNavigation<NativeStackNavigationProp<CruChewStackParams>>();
                    ...
                    <View style={{marginTop: '-12%'}}>
                        ...
                        <View
                            ...
                            <Text
                                ...
                                Welcome to the Akcru's Cru Chew, where you can order from your favorite restaurant and
                                have it delivered to your door while you're enjoying your favorite content.
                            </Text>
