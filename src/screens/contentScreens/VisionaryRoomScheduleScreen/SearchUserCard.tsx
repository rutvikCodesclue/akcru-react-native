...
type MITUserSearchCardProps = {
    ...
    setSelectedUsers: (selectedUsers: IUserProfile[]) => void;
};
...
const SearchUserCard = ({
    ...
    const selected = selectedUsers?.some(u => u.id === user.id) ?? false;
        ...
        <View
            ...
            <View style={{padding: 10}}>
                <View
                    ...
                    <View>
                        <TouchableOpacity
                            style={{alignItems: 'center', marginRight: 10, marginTop: 20}}
