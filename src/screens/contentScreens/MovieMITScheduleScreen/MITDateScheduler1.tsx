...
type MITDateScheduler1NavigationProp = StackNavigationProp<ClientStackParams, 'MITDateScheduler1'>;

type MITDateScheduler1RouteProp = RouteProp<ClientStackParams, 'MITDateScheduler1'>;

type Props = {
    navigation: MITDateScheduler1NavigationProp;
    route: MITDateScheduler1RouteProp;
};

const MITDateScheduler1 = ({route, navigation}: Props) => {
...
export default MITDateScheduler1;
