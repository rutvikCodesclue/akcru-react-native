...
const CrummunityScreen = ({navigation: navigationProp, route: routeProp, onFeedScroll}: Props = {}) => {
    const navigationFromHook = useNavigation<CrummunityScreenNavigationProp>();
    const routeFromHook = useRoute<RouteProp<CrummunityStackParams, keyof CrummunityStackParams>>();
    ...
    const author: IPost | null = (route?.params as {author?: IPost} | undefined)?.author ?? null;
                ...
                <SafeAreaView style={{flex: 1, backgroundColor: '#050508'}}>
                    <View style={{flex: 1, backgroundColor: '#050508'}}>
                        <FlatList
                            ...
                            onScroll={event => onFeedScroll?.(event.nativeEvent.contentOffset.y)}
