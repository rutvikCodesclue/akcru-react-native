...
/** @deprecated Kept for Metro Fast Refresh; renderItem no longer reads this. */
const TEMP_SHOW_POPULAR_FOR_INVITES_ON_ALL_CARDS = false;
...
export default function CruSoloTabsSoloSessionScreen({route}: Props) {
