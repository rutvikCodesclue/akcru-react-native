            ...
            <ImageBackground style={styles.bgimage} source={imageindex.AkcruonboardBG} resizeMode={'cover'}>
                <KeyboardAvoidingView behavior="padding" style={{flex: 1, marginBottom: 50}}>
                    <View style={styles.container}>
                        ...
                        <Text style={{...FONTS.Title2, textAlign: 'center'}}>
                            Now let's select a username that will be visible to other users. Additionally, provide us
                            with a brief description about yourself. This will help others get to know you better and
