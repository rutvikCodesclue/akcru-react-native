...
import { ClientStackParams } from "@app/navigation/ClientStack";
...
const StartMITDate = ({ navigation, route }: Props) => {
  const dateID: string | undefined = route.params?.dateID ?? null;
    ...
    <SafeAreaView>
      ...
      >
        ...
        {isStreamOpen ? (
          ...
          <View style={{ height: SIZES.ScreenHeight / 10.3 }}></View>
        )}
